...
public class DailyIncomeViewController{
    ...
    @FXML
    void picTheDateOnDateAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        System.out.println(dateView.getValue());

        setCustomersToTable(queryDAO.getDailyProfit(String.valueOf(dateView.getValue())));
    ...
    private void setDailyOrderDetail(){
